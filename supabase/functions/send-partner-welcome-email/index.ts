...
Deno.serve(async (req) => {
  ...
  try {
    ...
    if (!resendApiKey) {
      console.warn('[send-partner-welcome-email] RESEND_API_KEY not configured');
      return new Response(
    ...
    if (!emailResponse.ok) {
      ...
      console.error('[send-partner-welcome-email] Resend error:', errorText);
      return new Response(
    ...
    console.error('[send-partner-welcome-email] Error:', error);
    return new Response(
