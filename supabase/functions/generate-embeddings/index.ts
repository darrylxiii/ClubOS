...
Deno.serve(createHandler(async (req, ctx) => {
  ...
  const validation = validateInputSafe(embeddingsSchema, rawInput, ctx.corsHeaders);
  ...
  // Use Google Gemini to generate embeddings
  ...
  // Call OpenAI-compatible embeddings API via Google Gemini API
