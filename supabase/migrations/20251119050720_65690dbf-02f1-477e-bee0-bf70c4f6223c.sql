...
-- Add search_path to all new functions
...
CREATE OR REPLACE FUNCTION get_company_stats() RETURNS JSON LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION get_user_stats() RETURNS JSON LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION get_application_stats() RETURNS JSON LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION get_achievement_stats() RETURNS JSON LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION get_assessment_stats() RETURNS JSON LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
BEGIN
...
CREATE OR REPLACE FUNCTION get_system_health_stats() RETURNS JSON LANGUAGE plpgsql SECURITY DEFINER SET search_path = public AS $$
BEGIN
