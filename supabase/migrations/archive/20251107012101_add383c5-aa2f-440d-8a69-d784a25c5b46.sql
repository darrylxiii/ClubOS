-- Update generate_api_key function to use gen_random_uuid instead
...
DECLARE
  ...
  v_id UUID;
BEGIN
  -- Generate random key using gen_random_uuid: tqc_live_ + 32 chars
  ...
  -- Hash the full key using digest
