  ...
  return (
    <Card className={isSecure ? "border-green-500/20" : "border-orange-500/20"}>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div>
          <CardTitle className="text-sm font-medium">{t('security.storageBucketsCard.storageBuckets')}</CardTitle>
          <CardDescription>{t('security.storageBucketsCard.fileStorageSecurity')}</CardDescription>
        </div>
      ...
      <CardContent>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            <span className="text-xs text-muted-foreground">{t('security.storageBucketsCard.publicBuckets')}</span>
        ...
        <div className="mt-4 pt-4 border-t space-y-2">
          <div className="flex items-center gap-2 text-xs">
            ...
            <span className="text-muted-foreground">{t('security.storageBucketsCard.securityControls')}</span>
          </div>
          <div className="space-y-1 text-xs">
            <div className="flex justify-between">
              <span>{t('security.storageBucketsCard.sizeLimits')}</span>
              <span className="text-muted-foreground">{withSizeLimits} buckets</span>
            </div>
            <div className="flex justify-between">
              <span>{t('security.storageBucketsCard.mimeRestrictions')}</span>
