...
const TRACKER_STEPS = [
  ...
  { 
    id: 2, 
    name: "Review by The Quantum Club", 
    description: "Profile assessment in progress",
    status: "in_progress" as const
  },
  { 
    id: 3, 
    name: "Contact with A Talent Strategist", 
    description: "Initial outreach from your strategist",
    status: "in_progress" as const
  },
  { 
    id: 4, 
    name: "Assessment Call", 
    description: "In-depth discussion about your goals",
    status: "pending" as const
  },
  { 
    id: 5, 
    name: "Onboarding on the Platform", 
    description: "Full platform access & role matching",
    status: "pending" as const
  },
];
...
export function CandidateApplicationTracker() {
  ...
  const loadStrategist = async () => {
    // Fetch Darryl's profile (default strategist)
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-center gap-3 p-4 glass-effect border border-primary/20 rounded-2xl">
        ...
        <span className="text-sm font-semibold">
          <span className="text-green-500">12/50</span> candidate spots left for this quarter
        </span>
      </div>
