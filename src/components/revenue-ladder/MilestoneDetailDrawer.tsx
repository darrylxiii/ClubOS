...
import {
  ...
  Users, Clock, Gavel, History, ChevronRight, Sparkles,
  ArrowUpRight
} from 'lucide-react';
            ...
            <div className="flex h-full flex-col">
              ...
              <div className="flex items-start justify-between gap-4 border-b border-border p-6">
                <div className="space-y-1">
                  ...
                  <h2 className="text-heading-lg font-bold">{milestone.display_name}</h2>
              ...
              <ScrollArea className="flex-1">
                <div className="p-6 space-y-6">
                  {/* Amount & Progress */}
                  <Card variant="static" className="p-6 space-y-4 bg-muted/20">
                    <div className="flex items-start justify-between">
                      <div>
                        <p className="text-label-sm text-muted-foreground">Threshold</p>
                        <p className="text-display-sm font-bold">
                          {formatCurrency(milestone.threshold_amount)}
                        </p>
                      </div>
                      <div className="text-right">
                        <p className="text-label-sm text-muted-foreground">Achieved</p>
                    ...
                    <TabsList className="w-full">
                      <TabsTrigger value="proposals" className="flex-1 gap-2">
                        ...
                        {milestoneProposals.length > 0 && (
                          <Badge variant="secondary">{milestoneProposals.length}</Badge>
                        )}
                      </TabsTrigger>
...
function ProposalCard({ proposal, isAdmin, onDecide }: ProposalCardProps) {
  ...
  return (
    <Card variant="interactive" className="p-4 space-y-3">
