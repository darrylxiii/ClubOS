    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
        ...
        >
          ...
          {t('profileSection.requestResume')}
        </Button>
