...
export function AvatarAccountCard({ account, activeSession, socialTargets, onStartSession, onSyncLinkedIn, onEdit, onView, isSyncing }: AvatarAccountCardProps) {
  ...
  const hasLinkedInUrl = !!account.linkedin_url;
