  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        ...
        <Input
          placeholder={t('financialSection.searchCompanies')}
          value={search}
      ...
      <Card className="bg-muted/50">
        <CardContent className="py-3">
          <p className="text-sm">
            <span className="text-muted-foreground">{t('financialSection.moneybirdContact')}:</span>
        ...
        <div className="p-2 space-y-2">
          {filteredCompanies.length === 0 ? (
            <div className="text-center py-8 text-muted-foreground">
              {t('financialSection.noCompaniesFound')}
            </div>
          ) : (
      ...
      {selectedCompany && (
        <Card className="bg-primary/5 border-primary/20">
          <CardHeader className="pb-2">
            <CardTitle className="text-base">{t('financialSection.selectedCompany')}</CardTitle>
            <CardDescription>{t('financialSection.invoiceAttributedTo')}</CardDescription>
          </CardHeader>
          <CardContent>
