  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(buttonVariants({ variant: "ghost" }), "h-10 w-10 p-0 font-medium aria-selected:opacity-100 text-base"),
        ...
        day_today: "bg-accent/50 text-accent-foreground font-semibold ring-1 ring-primary/20",
        day_outside:
