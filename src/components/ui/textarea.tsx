...
const Textarea = React.forwardRef<HTMLTextAreaElement, TextareaProps>(({ className, ...props }, ref) => {
  return (
    <textarea
      className={cn(
        "flex min-h-[100px] w-full rounded-[12px] border-[0.5px] border-white/10 dark:border-white/5 bg-black/[0.03] dark:bg-black/20 backdrop-blur-xl px-4 py-3 text-base md:text-sm font-medium text-foreground shadow-[inset_0_1px_2px_rgba(0,0,0,0.1)] dark:shadow-[inset_0_1px_2px_rgba(0,0,0,0.5)]",
