...
const allCommands: CommandItem[] = [
  ...
  { id: "communication-hub", label: "Communication Hub", icon: Brain, path: "/admin/communication-hub", category: "AI & Tools", roles: ["admin", "strategist"] },
  { id: "unified-tasks", label: "Tasks", icon: ListTodo, path: "/tasks", category: "AI & Tools", roles: ["user", "partner", "admin", "strategist"] },
