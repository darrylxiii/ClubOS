...
interface SyncedBlockRenderProps {
  block: {
    props: {
      syncId: string;
    };
  ...
  editor: {
    updateBlock: (block: unknown, update: { props: { syncId: string } }) => void;
  };
  contentRef: React.RefObject<HTMLDivElement>;
}

function SyncedBlockRender(props: SyncedBlockRenderProps) {
...
export const SyncedBlock = createReactBlockSpec(
  ...
  {
    render: (props) => <SyncedBlockRender {...props as unknown as SyncedBlockRenderProps} />,
  }
);
