...
interface ToggleBlockRenderProps {
  block: {
    props: {
      isOpen: boolean;
    };
  ...
  editor: {
    updateBlock: (block: unknown, update: { props: { isOpen: boolean } }) => void;
  };
  contentRef: React.RefObject<HTMLDivElement>;
}

function ToggleBlockRender(props: ToggleBlockRenderProps) {
...
export const ToggleBlock = createReactBlockSpec(
  ...
  {
    render: (props) => <ToggleBlockRender {...props as unknown as ToggleBlockRenderProps} />,
  }
);
