...
interface MermaidBlockRenderProps {
  block: {
    props: {
      code: string;
    };
  ...
  editor: {
    updateBlock: (block: unknown, update: { props: { code: string } }) => void;
  };
}

function MermaidBlockRender(props: MermaidBlockRenderProps) {
...
export const MermaidBlock = createReactBlockSpec(
  ...
  {
    render: (props) => <MermaidBlockRender {...props as unknown as MermaidBlockRenderProps} />,
  }
);
