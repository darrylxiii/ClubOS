...
export function AudioCallInterface({ conversationId, participantName, onEnd }: AudioCallInterfaceProps) {
  ...
  const content = permissionDenied ? (
    <div className="fixed inset-0 z-[10000] bg-black/90 backdrop-blur-xl flex items-center justify-center w-screen h-screen"
    ...
    <div className="fixed inset-0 z-[10000] bg-gradient-to-br from-gray-900 via-gray-800 to-black flex items-center justify-center w-screen h-screen"
         style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0 }}>
