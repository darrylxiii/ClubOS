                  ...
                  <CardContent>
                    <div className="space-y-6">
                      ...
                      <div className="relative pt-8">
                        ...
                        {/* Threshold markers */}
                        <div 
                          className="absolute top-8 bottom-0 w-0.5 bg-yellow-500"
                          style={{ left: `${(minThreshold / maxThreshold) * 100}%` }}
                        >
                          <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-yellow-600 whitespace-nowrap">
                            Min
                          </div>
                        </div>
                        <div 
                          className="absolute top-8 bottom-0 w-0.5 bg-green-500"
                          style={{ left: `${(65915 / maxThreshold) * 100}%` }}
                        >
                          <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-green-600 whitespace-nowrap">
                            Optimal
                          </div>
                        </div>
                        <div 
                          className="absolute top-8 bottom-0 w-0.5 bg-blue-500"
                          style={{ left: `${(131823 / maxThreshold) * 100}%` }}
                        >
                          <div className="absolute -top-6 left-1/2 -translate-x-1/2 text-[10px] text-blue-600 whitespace-nowrap">
                            €15,750
                          </div>
                        </div>
                      </div>
