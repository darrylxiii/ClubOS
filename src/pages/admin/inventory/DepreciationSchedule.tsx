          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <Card>
              <CardContent className="pt-4">
                ...
                <p className="text-muted-foreground text-sm">Total Depreciation</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-4">
                <div className="text-2xl font-bold text-green-600">{totals.postedCount}</div>
                <p className="text-muted-foreground text-sm">Posted</p>
              </CardContent>
            </Card>
            <Card>
              <CardContent className="pt-4">
                <div className="text-2xl font-bold text-yellow-600">{totals.unpostedCount}</div>
