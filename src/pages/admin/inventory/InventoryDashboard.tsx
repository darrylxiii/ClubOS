...
const InventoryDashboard = () => {
  ...
  const handleCategoryClick = (category: string) => {
    navigate(`/admin/inventory?category=${category}`);
  };
          ...
          {loading ? (
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-4 mb-8">
                ...
                <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/admin/inventory/depreciation')}>
                  <CardContent className="pt-4">
                    <div className="flex items-center gap-2 text-muted-foreground text-sm mb-1">
                ...
                <Card className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => navigate('/admin/inventory/kia')}>
                  <CardContent className="pt-4">
                    <div className="flex items-center gap-2 text-muted-foreground text-sm mb-1">
                  ...
                  <CardContent>
                    <ResponsiveContainer width="100%" height={300}>
                      <BarChart data={monthlyTrend}>
                        ...
                        <Bar dataKey="postedDepreciation" fill="hsl(142, 76%, 36%)" name="Posted" radius={[4,4,0,0]} />
                      </BarChart>
                    </ResponsiveContainer>
                  </CardContent>
                </Card>
