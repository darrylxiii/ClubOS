...
export default function GodMode() {
  ...
  // Fetch admin impersonation sessions
      ...
      <RoleGate allowedRoles={["admin"]} showLoading>
        <div className="container mx-auto py-8 max-w-7xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Super-admin controls and system overrides
                </p>
              </div>
            </div>
          </div>
          ...
          <Alert variant="destructive" className="mb-6">
            ...
            <AlertDescription>
              All actions in this panel are logged and audited. Use with extreme caution.
            </AlertDescription>
          </Alert>
                ...
                <CardContent>
                  {flagsLoading ? (
                    ...
                    {featureFlags.map((flag: any) => (
                        ...
                        >
                          <div>
                            <p className="font-medium">{flag.name || flag.flag_key}</p>
                    ...
                    <EmptyState
                      ...
                      description="Feature flags will appear here when configured in the database."
                    />
                  )}
                </CardContent>
              </Card>
            ...
            <TabsContent value="user-lookup">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Search and view any user's profile
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
            ...
            <TabsContent value="impersonation">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    View history of admin impersonation sessions
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {sessionsLoading ? (
                    <div className="text-center py-8 text-muted-foreground">Loading sessions...</div>
                  ) : impersonationSessions && impersonationSessions.length > 0 ? (
                      ...
                      <div className="space-y-3">
                        {impersonationSessions.map((session: any) => (
                          ...
                          >
                            ...
                            <p className="text-sm">
                              Admin: <span className="font-medium">{session.admin_id}</span>
                            </p>
                            <p className="text-sm">
                              Target: <span className="font-medium">{session.target_user_id}</span>
                            </p>
                            {session.reason && (
                    ...
                    <EmptyState
                      ...
                      description="No admin impersonation sessions have been recorded."
                    />
                  )}
                </CardContent>
              </Card>
            ...
            <TabsContent value="database">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Direct database access and maintenance tools
                  </CardDescription>
                </CardHeader>
                <CardContent>
