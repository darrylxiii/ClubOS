...
import { Eye, Users, Clock, Search, Brain } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card className="bg-gradient-to-br from-card/90 to-card/60 backdrop-blur-xl">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">{t('gameAdmin.avgSelfAwareness', 'Avg. Self-Awareness')}</CardTitle>
