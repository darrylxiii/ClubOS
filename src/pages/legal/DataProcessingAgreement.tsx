...
export default function DataProcessingAgreement() {
  ...
  const sections = [
    ...
    { id: "definitions", title: t('text.dataprocessingagreement.definitions', 'Definitions') },
    { id: "scope", title: t('text.dataprocessingagreement.scopeOfProcessing', 'Scope of Processing') },
    { id: "data-categories", title: t('text.dataprocessingagreement.dataCategories', 'Data Categories') },
    { id: "obligations", title: t('text.dataprocessingagreement.processorObligations', 'Processor Obligations') },
    { id: "sub-processors", title: t('text.dataprocessingagreement.subprocessors', 'Sub-Processors') },
    { id: "security", title: t('text.dataprocessingagreement.securityMeasures', 'Security Measures') },
    { id: "data-subject-rights", title: t('text.dataprocessingagreement.dataSubjectRights', 'Data Subject Rights') },
    { id: "breach-notification", title: t('text.dataprocessingagreement.breachNotification', 'Breach Notification') },
    { id: "audits", title: t('text.dataprocessingagreement.auditRights', 'Audit Rights') },
    { id: "international-transfers", title: t('text.dataprocessingagreement.internationalTransfers', 'International Transfers') },
    { id: "termination", title: t('text.dataprocessingagreement.termTermination', 'Term & Termination') },
    { id: "contact", title: t('text.dataprocessingagreement.contact', 'Contact') },
  ];
      ...
      >
        <div className="space-y-8">
          ...
          <LegalSection id="introduction" title={"Introduction"}>
            <p>{t('text.dataprocessingagreement.thisDataProcessingAgreementDpaIs', 'This Data Processing Agreement ("DPA") is entered into between:')}</p>
            <div className="mt-4 space-y-4">
              <Card className="p-4 border-border/50">
                <p className="font-semibold">{"Data Controller (')Controller')"}</p>
                <p className="text-muted-foreground">{t('text.dataprocessingagreement.thePartnerCompanyUsingTheQuantum', 'The Partner company using The Quantum Club platform for recruitment services.')}</p>
              </Card>
              <Card className="p-4 border-border/50">
          ...
          <LegalSection id="scope" title={"Scope of Processing"}>
            <div className="flex items-start gap-3 mb-4">
              ...
              <p>{t('text.dataprocessingagreement.processorShallProcessPersonalDataOnly', 'Processor shall process Personal Data only for the following purposes:')}</p>
            </div>
          ...
          <LegalSection id="obligations" title={"Processor Obligations"}>
            ...
            <ul className="list-disc pl-6 mt-4 space-y-2 text-muted-foreground">
              ...
              <li>{t('text.dataprocessingagreement.notifyControllerOfAnyLegallyBinding', 'Notify Controller of any legally binding requests for disclosure (unless prohibited)')}</li>
            </ul>
          </LegalSection>

          <LegalSection id="sub-processors" title={"Sub-Processors"}>
            <p>{t('text.dataprocessingagreement.processorUsesTheFollowingCategoriesOf', 'Processor uses the following categories of Sub-Processors to deliver services:')}</p>
              ...
              <table className="w-full text-sm border border-border rounded-lg">
                ...
                <tbody className="divide-y divide-border">
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-3">{t('text.dataprocessingagreement.eu', 'EU')}</td>
                  </tr>
                  <tr>
          ...
          <LegalSection id="security" title={"Security Measures"}>
            <div className="flex items-start gap-3 mb-4">
              ...
              <p>{t('text.dataprocessingagreement.processorImplementsAppropriateTechnicalAndOrganiza', 'Processor implements appropriate technical and organizational measures including:')}</p>
            </div>
          ...
          <LegalSection id="data-subject-rights" title={"Data Subject Rights"}>
            <p>{t('text.dataprocessingagreement.processorShallAssistControllerInResponding', 'Processor shall assist Controller in responding to Data Subject requests including:')}</p>
            <ul className="list-disc pl-6 mt-4 space-y-2 text-muted-foreground">
          ...
          <LegalSection id="breach-notification" title={"Breach Notification"}>
            <div className="flex items-start gap-3 mb-4">
              ...
              <p>{t('text.dataprocessingagreement.inTheEventOfAPersonal', 'In the event of a Personal Data Breach, Processor shall:')}</p>
            </div>
            <ol className="list-decimal pl-6 space-y-3 text-muted-foreground">
              ...
              <li>
                <strong>{"Cooperate with Controller"}</strong> {t('text.dataprocessingagreement.inInvestigatingTheBreachAndFulfilling', 'in investigating the breach and fulfilling regulatory obligations')}
              </li>
              <li>
          ...
          <LegalSection id="audits" title={"Audit Rights"}>
            <p>{t('text.dataprocessingagreement.controllerHasTheRightToAudit', 'Controller has the right to audit Processor\'s compliance with this DPA:')}</p>
            <ul className="list-disc pl-6 mt-4 space-y-2 text-muted-foreground">
          ...
          <LegalSection id="termination" title={"Term & Termination"}>
            <p>{t('text.dataprocessingagreement.thisDpaRemainsInEffectFor', 'This DPA remains in effect for the duration of the MSA. Upon termination:')}</p>
            <ul className="list-disc pl-6 mt-4 space-y-2 text-muted-foreground">
              ...
              <li>{t('text.dataprocessingagreement.processorMayRetainDataAsRequired', 'Processor may retain data as required by law, subject to continued confidentiality')}</li>
            </ul>
          </LegalSection>

          <LegalSection id="contact" title={"Contact"}>
            <p>{t('text.dataprocessingagreement.forQuestionsAboutThisDpaOr', 'For questions about this DPA or to exercise rights under this agreement:')}</p>
