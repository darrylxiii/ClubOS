...
const ClientCandidateView = lazy(() => import("@/pages/shared/ClientCandidateView"));
    ...
    return (
        <>
            ...
            <Routes>
                ...
                {/* Client Presentation Portal (Public) */}
                <Route path="/shared/p/:token" element={
                    <PublicProviders>
                        <RouteErrorBoundary>
                            <Suspense fallback={<PageLoader />}><ClientCandidateView /></Suspense>
                        </RouteErrorBoundary>
                    </PublicProviders>
                } />
