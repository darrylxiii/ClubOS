...
export const quickTips: QuickTip[] = [
  ...
  },
  {
    id: '10',
    category: 'interview',
    title: 'The STAR Method Simplified',
  ...
  // Platform Features (6 tips)
  {
    id: '17',
    category: 'platform',
    title: 'Using Club AI to Find Your Perfect Role',
    description: 'Let AI match you with opportunities you would never find on job boards',
    icon: 'Sparkles',
  ...
  },
  {
    id: '18',
    category: 'platform',
    title: 'Club Sync: Auto-Apply to Perfect Matches',
    description: 'Save time by letting our strategists apply to matching roles for you',
    icon: 'Zap',
  ...
  },
  {
    id: '19',
    category: 'platform',
    title: 'Privacy Controls: Stealth Mode Explained',
    description: 'Keep your job search confidential from your current employer',
    icon: 'Shield',
  ...
  },
  {
    id: '20',
    category: 'platform',
    title: 'Dossier Sharing: Control What Partners See',
    description: 'Field-level visibility controls for your professional data',
    icon: 'Lock',
  ...
  },
  {
    id: '21',
    category: 'platform',
    title: 'Referral Rewards: Earn While You Help',
    description: 'Get paid for referring top talent to The Quantum Club',
    icon: 'Gift',
  ...
  },
  {
    id: '22',
    category: 'platform',
    title: 'Calendar Integration for Easy Scheduling',
    description: 'Connect Google or Microsoft Calendar for seamless interview booking',
    icon: 'Calendar',
  ...
  },
  {
    id: '24',
    category: 'insights',
    title: 'Salary Benchmarks by Role & Location',
