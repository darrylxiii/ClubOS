  ...
  admin: [
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Import History", icon: FileText, path: "/crm/imports" },
        { name: "Suppression List", icon: Shield, path: "/crm/suppression" },
        { name: "Audit Trail", icon: FileCheck, path: "/crm/audit-trail" },
